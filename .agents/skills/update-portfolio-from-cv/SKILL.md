...
- At ETHGlobal Lisbon 2026, Antonio contributed to Orloj, an ETHPrague-origin project built by colleagues and live at `https://app.orloj.xyz/`. He worked on the Uniswap and The Graph integrations: Uniswap V3 LP-management MCP tooling, a Graph-powered LP agent that gathers live subgraph evidence for LP decisions, and a chat bridge exposing the specialist through an internal MCP. Orloj won a 0G sponsor prize. Do not imply Antonio built the original ETHPrague foundation, and do not imply the team won Uniswap or The Graph sponsor prizes.
