...
- At ETHGlobal Lisbon 2026, Antonio contributed to Orloj Finance Agents, an ETHPrague-origin project built by colleagues, live at `https://app.orloj.xyz/`, and showcased at `https://ethglobal.com/showcase/orloj-finance-agents-jejoc`. He worked on the Uniswap and The Graph integrations: Uniswap V3 LP-management MCP tooling, a Graph-powered LP agent that gathers live subgraph evidence for LP decisions, and a chat bridge exposing the specialist through an internal MCP. Orloj Finance Agents won the Keep Building on 0G sponsor prize. Do not imply Antonio built the original ETHPrague foundation, and do not imply the team won Uniswap or The Graph sponsor prizes.
