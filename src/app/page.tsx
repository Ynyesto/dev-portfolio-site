      ...
      <section id="work" className="scroll-mt-24">
        ...
        <div className="space-y-6">
          ...
          <article className="panel p-6 sm:p-8">
            ...
            <p className="text-muted leading-relaxed mb-4 max-w-3xl">
              Independent production project for La Carta Deseada, the Spanish snail-mail club from
              De parte de B. I built the Astro customer site and the operations behind it: Stripe
              billing flows, a replay-safe webhook pipeline, Google Sheets-backed subscriber state,
              idempotent Brevo email delivery, and a Cloudflare Access-protected fulfillment
              dashboard.
            </p>
            <div className="flex flex-wrap gap-x-5 gap-y-2 text-sm">
              <Link
